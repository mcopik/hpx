...
#if !defined(HPX_COMPUTE_SYCL_TARGET_DISTRIBUTION_POLICY)
#define HPX_COMPUTE_SYCL_TARGET_DISTRIBUTION_POLICY
...
namespace hpx { namespace compute { namespace sycl
{
    ...
    struct target_distribution_policy
      : compute::detail::target_distribution_policy<sycl::target>
    {
        typedef compute::detail::target_distribution_policy<sycl::target>
            base_type;
...
{
    template <>
    struct is_distribution_policy<compute::sycl::target_distribution_policy>
      : std::true_type
    {};

    template <>
    struct num_container_partitions<compute::sycl::target_distribution_policy>
    {
        static std::size_t
        call(compute::sycl::target_distribution_policy const& policy)
        {
